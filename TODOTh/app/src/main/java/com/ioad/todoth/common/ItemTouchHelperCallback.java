...
public class ItemTouchHelperCallback extends ItemTouchHelper.Callback {
    ...
    private ButtonSate buttonSate = ButtonSate.GONE;
    ...
    public void onChildDraw(@NonNull Canvas c, @NonNull RecyclerView recyclerView, @NonNull RecyclerView.ViewHolder viewHolder, float dX, float dY, int actionState, boolean isCurrentlyActive) {
        if (actionState == ItemTouchHelper.ACTION_STATE_SWIPE) {
            if (buttonSate != ButtonSate.GONE) {
                if (buttonSate == ButtonSate.LEFT_VISIBLE) dX = Math.max(dX, buttonWidth);
                if (buttonSate == ButtonSate.RIGHT_VISIBLE) dX = Math.max(dX, -buttonWidth);
    ...
    private void drawButtons(Canvas c, RecyclerView.ViewHolder viewHolder) {
        ...
        if (buttonSate == ButtonSate.LEFT_VISIBLE) {
        ...
        } else if (buttonSate == ButtonSate.RIGHT_VISIBLE) {
    ...
    private void setTouchListener(final Canvas c, final RecyclerView recyclerView,
        ...
        recyclerView.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (swipeBack) {
                    if (dX < -buttonWidth) buttonSate = ButtonSate.RIGHT_VISIBLE;

                    else if (dX > buttonWidth) buttonSate = ButtonSate.LEFT_VISIBLE;
